    ...
    liff
        ...
        .then(() => {
            ...
            function startApp() {
                ...
                var userLineId = liff.getContext().userId;
                // Display the user's LINE user ID
                document.getElementById('userLineId').textContent = 'User ID: ' + userLineId;
                ...
                document.getElementById('dataEntryForm').addEventListener('submit', function(event) {
                    ...
                    if (fileInput.files.length > 0) {
                        ...
                        var storageRef = storage.ref().child('pictures/' + fileName);
                        ...
                        storageRef.put(file)
                            ...
                            .then(function(downloadURL) {
                                ...
                                var newEntryRef = database.ref('entries').push({
                                    ...
                                    tel: tel,
                                    detail: detail,
                                    picture: downloadURL, // Use the download URL of the uploaded file
                                    latitude: latitude,
                                    longitude: longitude,
                                });
                        ...
                        // No file selected, save the data without the picture
                        var newEntryRef = database.ref('entries').push({
                            name: name,
                            email: email,
                            tel: tel,
                ...
                function sendFlexMessageToUser(userLineId, name, email, tel, detail, latitude, longitude) {
                    ...
                    var headers = {
                        Authorization: 'Bearer aTL1JId8NHTkiFywle6sXH7/peXv898r0DLCDCsSw2tryErguUEo9p4RITUMZv8lgRmxNwe1PMNih1yVM987DKCk85LWlZr0ybfKgGnVCFastAwPf21zjgalm7WYpDa3sn3Z6d/nUGX8zBV/gYJgLwdB04t89/1O/w1cDnyilFU=', // Replace with your LINE Messaging API channel access token
                ...
                // Check the device platform and display the platform message
                var platformMessage = '';
                if (liff.isInClient()) {
                    if (liff.getOS() === 'ios') {
                        platformMessage = 'iOS';
                    ...
                    platformMessage = 'Web browser';
                }

                // Display the platform message in HTML
                document.getElementById('platformMessage').textContent = 'Platform: ' + platformMessage;

                // Check the device platform and set the background color
                var isIOS = liff.getOS() === 'ios';
                if (isIOS) {
